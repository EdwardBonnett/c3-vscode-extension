...
export module Matching {
    ...
    export interface TypedMatcher<T extends Node> extends NodeMatcher {
        ...
        secondaryNodeType(): ts.SyntaxKind | null;
    }
    ...
    export class BasicMatcher {
        ...
        doMatch(n: Node): any {
            ...
            if (this.nodeType() === n.kind || (this.secondaryNodeType && this.secondaryNodeType() === n.kind)) {
                return this.match(n);
            }
        }
    }
    ...
    export class FieldMatcher extends BasicMatcher implements TypedMatcher<ts.ClassDeclaration> {
        ...
        secondaryNodeType() {
            return ts.SyntaxKind.PropertySignature;
        }
    }
    ...
    export function visit<T>(n: Node, cb: NodeCallback<T>): T | null | undefined {
        var r0 = cb(n);
        if (r0) {
            if (r0 === SKIP) {
                return null;
    ...
    export function exprStmt(eM: TypedMatcher<Expression>,
        ...
        return new ExpressionStatementMatcher(eM as TypedMatcher<Expression>, tr as Transformer<Expression, any>);
    }
